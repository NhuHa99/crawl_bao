...
class Helpers {
	...
	public function sendRequest( $url, $body = [], $headers = [] ) {
		if ( $url === 'https://licensing.aioseo.com/v1/activate/' || $url === 'https://licensing.aioseo.com/v1/addons/' ) {
			return json_decode( '{"success":true,"product_id":"AAAAAAAAAA","all_activations":["localhost"],"key":"AAAAAAAAAAAAAAAA","level":"business","expires":"2023-01-01 00:00:00","counts":{"total":99,"used":0,"remaining":99,"local":1}}' );
		}
