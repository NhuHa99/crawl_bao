...
class License {
	...
	public function activate() {
		...
		aioseo()->internalOptions->internal->license->level   = 1;
		aioseo()->internalOptions->internal->license->expires = strtotime( '+1200 days' );
		return true;
	}
	...
	public function pluginRowNotice() {
		if ( ! $this->isActive() && ! is_network_admin() ) {
			...
			$licenseKey = '1415b451be1a13c283ba771ea52d38bb';
