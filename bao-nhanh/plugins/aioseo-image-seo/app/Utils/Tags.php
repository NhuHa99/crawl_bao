...
class Tags {
	...
	public function replaceTags( $string, $id, $stripPunctuation = false ) {
		...
		return preg_replace( '/>thisisjustarandomplaceholder<(?![a-zA-Z0-9_])/im', aioseo()->helpers->decodeHtmlEntities( aioseo()->options->searchAppearance->global->separator ), $string );
	}
