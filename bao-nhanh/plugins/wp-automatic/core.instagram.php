...
class WpAutomaticInstagram extends wp_automatic {
	...
	function instagram_fetch_items($keyword, $camp) {
		...
		if( ! in_array ( 'OPT_IT_USER', $camp_opt ) && $jsonArr->graphql->hashtag->edge_hashtag_to_media->count == 0 && count($jsonArr->graphql->hashtag->edge_hashtag_to_top_posts->edges) >0){
